...

  {
    ...
    fields: [
      ...
      },
      {
        ...
        required: true,
        options: [
          { key: "reduce_wait_times", label: "Reduce Wait Times" },
          { key: "increase_outbound_sales", label: "Increase Outbound Sales" },
      ...
      },
      {
        ...
        label: "Additional Information to be Added to Knowledge Base",
        type: "textarea",
        placeholder: "Paste additional content here for the AI to reference",
        required: false,
      },
      {
        id: "agent_tone",
