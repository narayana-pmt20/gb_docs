...
export const mockTodos: Todo[] = [
...

  {
    ...
    title: "Setup CRM - Provide Configuration Details",
    description:
...

  {
    ...
    description:
      "Configure your AI Voice Agent with your business details, call preferences, integrations, and knowledge sources to enable automated voice calls for your business.",
    archetype: "information_request",
    status: "not_started",
    priority: "critical",
    priorityScore: 0.98,
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Industry",
        type: "text",
        prefill_key: "analysis.business_industry",
        required: true,
      },
      {
        id: "primary_goal",
        label: "Primary Goal",
        type: "text",
        placeholder: "e.g., Reduce Wait Times, Increase Outbound Sales, Automate Support",
        required: true,
      },
      {
        id: "target_languages",
      ...
      },
      {
        ...
        label: "Minutes per Month You Would Like to Have",
        type: "dropdown",
        required: true,
        options: [
          { key: "100", label: "100 minutes" },
          { key: "200", label: "200 minutes" },
          { key: "400", label: "400 minutes" },
          { key: "600", label: "600 minutes" },
        ],
      },
      {
        id: "call_direction",
        ...
        options: [
          ...
          { key: "hybrid", label: "Hybrid (Both)" },
          { key: "website_widget", label: "Website Widget" },
        ],
      },
      {
        id: "voice_agent_timezone",
        label: "Timezone in Which the Voice Agent Should Operate",
        type: "dropdown",
        prefill_key: "account.timezone",
        required: true,
        options: [
          { key: "et", label: "Eastern Time (ET)" },
          { key: "ct", label: "Central Time (CT)" },
      ...
      },
      {
        ...
        required: true,
        options: [
          { key: "call_transcript_emails", label: "Call transcript emails" },
          { key: "call_transfer", label: "Call transfer" },
          { key: "appointment_booking", label: "Appointment booking" },
        ],
      },
      {
        id: "call_tasks",
        label: "What Specific Tasks Should the AI Perform During a Call?",
        type: "checkbox",
        required: true,
        options: [
          { key: "lead_qualification", label: "Lead Qualification" },
          { key: "appointment_scheduling", label: "Appointment Scheduling" },
          { key: "live_transfer", label: "Live Transfer" },
          { key: "information_gathering", label: "Information Gathering" },
          { key: "faq_resolution", label: "FAQ Resolution" },
        ],
      },
      {
        id: "crm_system",
        label: "CRM System",
        type: "text",
        placeholder: "e.g., GoHighLevel, Salesforce, HubSpot",
        required: true,
      },
      {
        id: "calendar_tool",
        label: "Calendar Tool",
        type: "text",
        placeholder: "e.g., Google Calendar, Cal.com",
        required: true,
      },
      {
        id: "automated_sms",
      ...
      {
        id: "webhooks",
        label: "Send Call Summaries to a Third-Party App (Zapier, Make, etc.)?",
        type: "radio",
        required: true,
        options: [
          { key: "yes", label: "Yes" },
      ...
      },
      {
        ...
        type: "url",
        placeholder: "https://example.com or paste document content",
        required: false,
      },
      {
        id: "knowledge_base_documents",
        label: "Knowledge Base to Feed to the AI Voice Agent",
        type: "textarea",
        placeholder: "Paste your knowledge base content here (other than the website)",
        required: false,
      },
      {
        id: "agent_tone",
        ...
        options: [
          ...
          { key: "friendly", label: "Friendly/Casual" },
